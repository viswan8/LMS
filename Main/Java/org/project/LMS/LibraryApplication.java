...
public class LibraryApplication {
    ...
    public static void main(String[] args) {
        ...
        LibraryLendingManager lendingManager = new LibraryLendingManager(bookRepository, patronRepository);
        ...
        //Patron Management
        IPatron patron1 = patronFactory.createPatron("P001", "Viswanath Raj", "viswa.raj@gmail.com");
        patronRepository.addPatron(patron1);

        IPatron patron2 = patronFactory.createPatron("P002", "Vishnu Gautham", "vishnu.goutham@gmail.com");
        patronRepository.addPatron(patron2);

        // Try adding a duplicate patron
        try {
            IPatron duplicatePatron = patronFactory.createPatron("P001", "Viswanath Raj", "viswa.raj@gmail.com");
        ...
        for (IBook b : gatsbyBooks) {
            System.out.println("  - " + b.getTitle());
        }
        System.out.println();

        // Final Inventory and Patron State
        System.out.println("--- Final Library State ---");
        System.out.println("All Books:");
        for (IBook book : bookRepository.getAllBooks()) {
            System.out.println(book);
        }
        System.out.println("\nAll Patrons:");
        for (IPatron p : patronRepository.getAllPatrons()) {
            System.out.println(p);
            //stream for collecting titles
